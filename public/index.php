    ...
    <div class="wrapper">
        ...
        <header id="header" class="header shadow">
            <div class="header-inner">
                ...
                <div class="logo">
                    <a href="index.php">
                        <h1><font color="white">SOUND<font color="grey">LEVEL
                    </a>
                </div>
                <!-- End Logo -->
                      ...
                      <div class="intro-Rev_Video text-center dark-bg black-bg">
                          <ul>
                              <li data-transition="fadein" data-slotamount="default" data-saveperformance="off" data-fsslotamount="7">
                                  <!-- MAIN IMAGE -->
                                  <img src="img/fundo.jpg" alt="video_forest" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">
                                  <!-- LAYERS -->
